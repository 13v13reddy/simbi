...
public enum NoteOperations {
    ...
    /// True for names generated by either the regular New Note action or
    /// menubar quick capture. The auto-titler renames only notes whose title
    /// is still one of these defaults.
    public static func isDefaultNoteName(_ name: String) -> Bool {
        name.wholeMatch(of: /New Note( [0-9]+)?/) != nil
            || name.wholeMatch(of: /[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}-[0-9]{2}( [0-9]+)?/)
                != nil
    }
}
